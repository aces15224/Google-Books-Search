...
class Results extends Component {
    ...
    componentDidMount() {
        API.savedBooks()
            .then(savedBooks => this.setState({ savedBooks: res.data }))
        ...
        return (
            <div>
                {!this.props.books.length ? (
                    <h1 className="text-center">Your Search Yielded No Results</h1>
                ) : (
                        <div>
                                        ...
                                        <div className="col-md-10">
                                            <div className="card-body">
                                                ...
                                                <div>
                                                    ...
                                                    <button onClick={() => this.handleSavedButton(result)} className="btn badge-pill btn-outline-warning mt-3 ml-3" >
